"""Streamlit dashboard for blast vibration field review."""
...
from mineralforge.models.prediction import prepare_prediction_data
from mineralforge.utils.paths import DEFAULT_DATA_PATH, DEFAULT_MODEL_PATH
...
def run_dashboard() -> None:
    ...
    st.set_page_config(page_title="MineralForge Blast Vibration Risk", layout="wide")
    st.title("MineralForge Blast Vibration Risk Predictor")
    ...
    if FEATURE_IMPORTANCE_PATH.exists():
        ...
        st.bar_chart(pd.read_csv(FEATURE_IMPORTANCE_PATH).head(15), x="feature", y="importance")
    st.subheader("Scored Blast Events")
